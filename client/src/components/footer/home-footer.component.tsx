...
const  social = [
    ...
    {
        name: 'Blog Site',
        href: 'https://www.travcodez.com',
        icon: ({className, ariaHidden}:IIconProps) => (
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" aria-hidden={ariaHidden} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const HomeFooter = () => {
  return (
    <footer className="bg-tertiary-black py-4 px-4 md:px-0 fixed bottom-0 w-full text-tertiary-gray">
